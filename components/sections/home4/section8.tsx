							...
							<div className="contact4-header heading7">
								...
								<div className="contact-author-box" data-aos="fade-left" data-aos-duration={1000}>
									...
									<div className="text">
										...
										<Link href="/mailto:chessvictoriasecretary@gmail.com">chessvictoriasecretary@gmail.com</Link>
									</div>
								</div>
								...
								<div className="contact-author-box" data-aos="fade-left" data-aos-duration={1200}>
									...
									<div className="text">
										<h4>Schedule</h4>
										<div className="space10" />
										<Link href="/mailto:chessvictoriasecretary@gmail.com">Sunday-Fri: 9 AM – 6 PM</Link>
									</div>
								</div>
							</div>
						</div>
