...
export default function LayoutClient({ headerStyle, footerStyle, breadcrumbTitle, children, menu }: LayoutClientProps) {
    ...
    return (
        <>
            <div id="top" />
            <AddClassBody />
            {!headerStyle && <MainSiteHeader scroll={scroll} isMobileMenu={isMobileMenu} handleMobileMenu={handleMobileMenu} isSearch={isSearch} handleSearch={handleSearch} menu={menu} />}
            {headerStyle == 1 ? <MainSiteHeader scroll={scroll} isMobileMenu={isMobileMenu} handleMobileMenu={handleMobileMenu} isSearch={isSearch} handleSearch={handleSearch} menu={menu} /> : null}
            ...
            <MobileMenu isMobileMenu={isMobileMenu} handleMobileMenu={handleMobileMenu} menu={menu} />
