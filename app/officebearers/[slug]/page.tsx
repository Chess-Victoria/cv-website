...
export default async function OfficeBearersMemberPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <>
      <Layout headerStyle={1} footerStyle={1}>
        <div>
          <PageHeadContent
            title="Office Bearer Details"
            backgroundImage="/assets/img/bg/header-bg7.png"
            breadcrumbs={[{ name: 'Home', link: '/' }, { name: 'Office Bearers', link: '/officebearers' }, { name: member.person.name, link: `/officebearers/${member.slug}` }]}
          />
          {/*===== HERO AREA ENDS =======*/}
          {/*===== TEAM AREA STARTS =======*/}
                      ...
                      <div className="col-lg-3">
                        <div className="our-team-boxarea">
                          ...
                          <div className="content-area">
                            <Link href={`/officebearers/${member.slug}`}>{member.person.name}</Link>
                            ...
                            <ul>
                              <li>
                                <Link href={`/officebearers/${member.slug}`} className="icon1"><i className="fa-solid fa-user" /></Link>
                              </li>
                              {member.person.email && (
                                <li>
                              ...
                              <li>
                                <Link href={`/officebearers/${member.slug}`} className="icon4"><i className="fa-solid fa-info" /></Link>
                              </li>
                            </ul>
                          </div>
                        </div>
                      ...
                      <div className="col-lg-7">
                        <div className="speakesr-details-content heading2">
                          ...
                          {member.about ? (
                            ...
                            <p>No detailed information available for this office bearer.</p>
                          )}
