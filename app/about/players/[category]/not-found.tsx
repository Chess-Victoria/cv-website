...
export default function NotFound() {
  return (
    <NotFoundPage
      title="Player Category Not Found"
      subtitle="404 - Category Not Found"
      description="The player category you're looking for doesn't exist or may have been moved."
      primaryAction={{
      ...
      breadcrumbs={[
        ...
        { name: 'Not Found', link: '/about/players' }
      ]}
