																...
																<div className="accordion" id="accordionExample">
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (1)}>
																			<button className={isAccordion == 1 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">What is Chess Victoria, and who is it for?</button>
																		</h2>
																		<div id="collapseOne" className={isAccordion == 1 ? "accordion-collapse collapse show" : "accordion-collapse collapse"} data-bs-parent="#accordionExample">
																			<div className="accordion-body">
																				<p>Chess Victoria 2024 will be held on 26 at USA , located in New York. Full event details, including timings and venue information, will be provided after registration.</p>
																			</div>
																		</div>
																	</div>
																	<div className="space20" />
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (2)}>
																			<button className={isAccordion == 2 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">When and where is Chess Victoria 2024 taking place?</button>
																		</h2>
																	...
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (3)}>
																			<button className={isAccordion == 3 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">How much does it cost to attend Chess Victoria 2024?</button>
																		</h2>
																	...
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (4)}>
																			<button className={isAccordion == 4 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">Will there be networking opportunities Chess Victoria?</button>
																		</h2>
																...
																<div className="accordion" id="accordionExample3">
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (11)}>
																			<button className={isAccordion == 11 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseEleven" aria-expanded="true" aria-controls="collapseEleven">What is Chess Victoria, and who is it for?</button>
																		</h2>
																	...
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (12)}>
																			<button className={isAccordion == 12 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwelve" aria-expanded="false" aria-controls="collapseTwelve">When and where is Chess Victoria 2024 taking place?</button>
																		</h2>
																	...
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (13)}>
																			<button className={isAccordion == 13 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseThirteen" aria-expanded="false" aria-controls="collapseThirteen">How much does it cost to attend Chess Victoria 2024?</button>
																		</h2>
																	...
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (14)}>
																			<button className={isAccordion == 14 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseFourteen" aria-expanded="false" aria-controls="collapseFourteen">Will there be networking opportunities Chess Victoria?</button>
																		</h2>
																...
																<div className="accordion" id="accordionExample4">
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (16)}>
																			<button className={isAccordion == 16 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseThirtysix" aria-expanded="true" aria-controls="collapseThirtysix">What is Chess Victoria, and who is it for?</button>
																		</h2>
																	...
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (17)}>
																			<button className={isAccordion == 17 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseThirtyseven" aria-expanded="false" aria-controls="collapseThirtyseven">When and where is Chess Victoria 2024 taking place?</button>
																		</h2>
																	...
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (18)}>
																			<button className={isAccordion == 18 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseThirtyeight" aria-expanded="false" aria-controls="collapseThirtyeight">How much does it cost to attend Chess Victoria 2024?</button>
																		</h2>
																	...
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (19)}>
																			<button className={isAccordion == 19 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseThirtynine" aria-expanded="false" aria-controls="collapseThirtynine">Will there be networking opportunities Chess Victoria?</button>
																		</h2>
																...
																<div className="accordion" id="accordionExample5">
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (21)}>
																			<button className={isAccordion == 21 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseSixteen" aria-expanded="true" aria-controls="collapseSixteen">What is Chess Victoria, and who is it for?</button>
																		</h2>
																	...
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (22)}>
																			<button className={isAccordion == 22 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseSeventeen" aria-expanded="false" aria-controls="collapseSeventeen">When and where is Chess Victoria 2024 taking place?</button>
																		</h2>
																	...
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (23)}>
																			<button className={isAccordion == 23 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseEightteen" aria-expanded="false" aria-controls="collapseEightteen">How much does it cost to attend Chess Victoria 2024?</button>
																		</h2>
																	...
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (24)}>
																			<button className={isAccordion == 24 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseNineteen" aria-expanded="false" aria-controls="collapseNineteen">Will there be networking opportunities Chess Victoria?</button>
																		</h2>
																...
																<div className="accordion" id="accordionExample6">
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (26)}>
																			<button className={isAccordion == 26 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseFourtyone" aria-expanded="true" aria-controls="collapseFourtyone">What is Chess Victoria, and who is it for?</button>
																		</h2>
																	...
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (27)}>
																			<button className={isAccordion == 27 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseFourtytwo" aria-expanded="false" aria-controls="collapseFourtytwo">When and where is Chess Victoria 2024 taking place?</button>
																		</h2>
																	...
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (28)}>
																			<button className={isAccordion == 28 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseFourtythree" aria-expanded="false" aria-controls="collapseFourtythree">How much does it cost to attend Chess Victoria 2024?</button>
																		</h2>
																	...
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (29)}>
																			<button className={isAccordion == 29 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseFourtyfour" aria-expanded="false" aria-controls="collapseFourtyfour">Will there be networking opportunities Chess Victoria?</button>
																		</h2>
																...
																<div className="accordion" id="accordionExample7">
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (31)}>
																			<button className={isAccordion == 31 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwentyone" aria-expanded="true" aria-controls="collapseTwentyone">What is Chess Victoria, and who is it for?</button>
																		</h2>
																	...
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (32)}>
																			<button className={isAccordion == 32 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwentytwo" aria-expanded="false" aria-controls="collapseTwentytwo">When and where is Chess Victoria 2024 taking place?</button>
																		</h2>
																	...
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (33)}>
																			<button className={isAccordion == 33 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwentythree" aria-expanded="false" aria-controls="collapseTwentythree">How much does it cost to attend Chess Victoria 2024?</button>
																		</h2>
																	...
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (34)}>
																			<button className={isAccordion == 34 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwentyfour" aria-expanded="false" aria-controls="collapseTwentyfour">Will there be networking opportunities Chess Victoria?</button>
																		</h2>
																...
																<div className="accordion" id="accordionExample8">
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (36)}>
																			<button className={isAccordion == 36 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseFourtySix" aria-expanded="true" aria-controls="collapseFourtySix">What is Chess Victoria, and who is it for?</button>
																		</h2>
																	...
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (37)}>
																			<button className={isAccordion == 37 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseFourtySeven" aria-expanded="false" aria-controls="collapseFourtySeven">When and where is Chess Victoria 2024 taking place?</button>
																		</h2>
																	...
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (38)}>
																			<button className={isAccordion == 38 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseFourtyEight" aria-expanded="false" aria-controls="collapseFourtyEight">How much does it cost to attend Chess Victoria 2024?</button>
																		</h2>
																	...
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (39)}>
																			<button className={isAccordion == 39 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseFourtyNine" aria-expanded="false" aria-controls="collapseFourtyNine">Will there be networking opportunities Chess Victoria?</button>
																		</h2>
																...
																<div className="accordion" id="accordionExample9">
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (41)}>
																			<button className={isAccordion == 41 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwentysix" aria-expanded="true" aria-controls="collapseTwentysix">What is Chess Victoria, and who is it for?</button>
																		</h2>
																	...
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (42)}>
																			<button className={isAccordion == 42 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwentyseven" aria-expanded="false" aria-controls="collapseTwentyseven">When and where is Chess Victoria 2024 taking place?</button>
																		</h2>
																	...
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (43)}>
																			<button className={isAccordion == 43 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwentyeight" aria-expanded="false" aria-controls="collapseTwentyeight">How much does it cost to attend Chess Victoria 2024?</button>
																		</h2>
																	...
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (44)}>
																			<button className={isAccordion == 44 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwentynine" aria-expanded="false" aria-controls="collapseTwentynine">Will there be networking opportunities Chess Victoria?</button>
																		</h2>
																...
																<div className="accordion" id="accordionExample10">
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (46)}>
																			<button className={isAccordion == 46 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseThirtyone" aria-expanded="true" aria-controls="collapseThirtyone">What is Chess Victoria, and who is it for?</button>
																		</h2>
																	...
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (47)}>
																			<button className={isAccordion == 47 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseThirtytwo" aria-expanded="false" aria-controls="collapseThirtytwo">When and where is Chess Victoria 2024 taking place?</button>
																		</h2>
																	...
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (48)}>
																			<button className={isAccordion == 48 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseThirtythree" aria-expanded="false" aria-controls="collapseThirtythree">How much does it cost to attend Chess Victoria 2024?</button>
																		</h2>
																	...
																	<div className="accordion-item">
																		<h2 className="accordion-header"onClick={() => handleAccordion (49)}>
																			<button className={isAccordion == 49 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseThirtyfour" aria-expanded="false" aria-controls="collapseThirtyfour">Will there be networking opportunities Chess Victoria?</button>
																		</h2>
